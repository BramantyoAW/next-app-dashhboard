...
import { Home, Globe, Package, Layers, ShoppingCart, MessageCircle, Settings, LogOut, X, ArrowLeft, FileText, Ticket, FolderTree, MessageSquareQuote, Megaphone } from 'lucide-react';
...
const WEB_STORE_NAV = [
  ...
  { href: '/owner/web-store/broadcast', label: 'Broadcast Promo', icon: Megaphone },
];
